...
t1 = transformer1._transform_x1_thermometer(df_spark)
t2 = transformer1._transform_y1_thermometer(t1)
t3 = transformer1._transform_x2_thermometer(t2)
t4 = transformer1._transform_y2_thermometer(t3)
...
clus = CluswisardEstimator(11, 11, 4, 10, 0.1)
